...
class BrokerBinSOAP {
     ...
     *
     * @return {BrokerBinSOAP} The `BrokerBinSOAP` instance.
     */
    constructor(auth = {}) {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.soapClient.Search({
                ...
                try {
                    ...
                    console.error("[BROKERBIN_ERROR] The original response is: ", res)
                    console.error(`[BROKERBIN_ERROR] Search:`, reqPart, reqOptions)
                    console.error(e)
                    res = {}
                    res.resultset = [{
                        result: []
                ...
                if (!Array.isArray(results)) {
                    if (res.serialized === "C") {
                        this.soapUid = null
                        this.search(reqPart, reqOptions).then(resolve).catch(reject)
                        return
                    }
                    console.error(`[BROKERBIN_ERROR] Brokerbin result is not an array.`, res)
                    console.error(`[BROKERBIN_ERROR] Search:`, reqPart, reqOptions)
                    results = []
                }
...
BrokerBinREST.SOAP = BrokerBinSOAP
BrokerBinREST.REST = BrokerBinREST
